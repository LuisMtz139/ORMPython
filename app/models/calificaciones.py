from sqlalchemy import Column, BigInteger, ForeignKey, Double
...
class CalificacionesInDB(Base):
    ...
    ordinario_1 = Column(Double)
    ordinario_2 = Column(Double)
    ordinario_3 = Column(Double)
    recuperacion_1 = Column(Double)
    recuperacion_2 = Column(Double)
    recuperacion_3 = Column(Double)
    extra = Column(Double)
    final = Column(Double)
